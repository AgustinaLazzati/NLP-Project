...
df_crf_unc_test.to_csv('df_crf_unc_test.csv', index=False)
df_crf_unc_train.to_csv('df_crf_unc_train.csv', index=False)
df_crf_neg_train.to_csv('df_crf_neg_train.csv', index=False)
df_crf_neg_test.to_csv('df_crf_neg_test.csv', index=False)
